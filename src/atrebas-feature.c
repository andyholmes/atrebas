                             ...
                             GError   **error)
{
  ...
  color = atrebas_get_string (props, "color", "#000000");
  name = atrebas_get_string (props, "Name", "Unknown");
  name_fr = atrebas_get_string (props, "FrenchName", name);
  nld_id = json_object_get_string_member (feature, "id");
  slug = atrebas_get_string (props, "Slug", "");
  uri = atrebas_get_string (props, "description", "https://native-land.ca");
  uri_fr = atrebas_get_string (props, "FrenchDescription", uri);
